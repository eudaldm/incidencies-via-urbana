...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonItem, IonNote, IonButton, IonInput, IonCard, ToastController } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCard, IonInput, IonButton, IonNote, IonItem, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, ReactiveFormsModule]
})
