...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonItem, IonNote, IonButton, IonToast, IonInput, IonCard } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCard, IonInput, IonToast, IonButton, IonNote, IonItem, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, ReactiveFormsModule]
})
